...
namespace MeGUI
{
    ...
    public class MeGUISettings
    {
        ...
        public MeGUISettings()
		{
            ...
            autoUpdateServerLists = new string[][] { new string[] { "穩定的", "http://megui.org/auto/stable/" },
                new string[] { "開發中", "http://megui.org/auto/", "http://megui.xvidvideo.ru/auto/" }, new string[] { "自訂義"}};
        ...
        public string[][] AutoUpdateServerLists
        {
            get
            {
                ...
                {
                    autoUpdateServerLists[0] = new string[] { "穩定的", "http://megui.org/auto/stable/" };
                    autoUpdateServerLists[1] = new string[] { "開發中", "http://megui.org/auto/", "http://megui.xvidvideo.ru/auto/" };
                }
                else
                {
                    autoUpdateServerLists = new string[][] { new string[] { "穩定的", "http://megui.org/auto/stable/" },
                                                             new string[] { "開發中", "http://megui.org/auto/", "http://megui.xvidvideo.ru/auto/" }, 
                                                             new string[] { "自訂義"}};
                }
#endif
#if x64 && !DEBUG
                autoUpdateServerLists = new string[][] { new string[] { "穩定的", "http://megui.org/auto/", "http://megui.xvidvideo.ru/auto/" },
                                                         new string[] { "開發中", "http://megui.org/auto/", "http://megui.xvidvideo.ru/auto/" },
                                                         new string[] { "自訂義"}};
#endif
#if DEBUG
                autoUpdateServerLists = new string[][] { new string[] { "穩定的", "http://megui.org/auto/" },
                                                         new string[] { "開發中", "http://megui.org/auto/" },
                                                         new string[] { "自訂義", "http://megui.org/auto/" }};
#endif
