...
namespace MeGUI
{
    public partial class VideoEncodingComponent : UserControl
    {
        ...
        private void VideoInput_DoubleClick(object sender, System.EventArgs e)
        {
            ...
            else MessageBox.Show("請先讀取 AviSynth 腳本...", "訊息", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        private void queueVideoButton_Click(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show(settingsError, "不支持的設定", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
        ...
        private void addAnalysisPass_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("錯誤: 無法添加任務到佇列，請確認輸入的項目是正確的", "無法建立任務", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void editZonesButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("請先讀取 AviSynth 腳本...", "訊息", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
