...
namespace MeGUI.core.gui
{
    ...
    public partial class JobWorker : Form
    {
        ...
        public JobWorker(MainForm mf)
        {
            ...
            jobQueue1.AddMenuItem("返回主要任務佇列", null, delegate(List<TaggedJob> jobs)
            {
        ...
        {
            DialogResult r = MessageBox.Show("您確定要刪除這個任務工作區嗎?", "確定要刪除嗎?", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
