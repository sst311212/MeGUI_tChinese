...
namespace MeGUI.core.gui
{
    public partial class LogTree : UserControl
    {
        ...
        private void saveBranch_Click(object sender, EventArgs e)
        {
            ...
            if (i == null)
            {
                MessageBox.Show("No log branch selected", "無法儲存檔案", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            save(i);
        }
        ...
        private void save(LogItem i)
        {
            ...
            try
            {
                ...
                MessageBox.Show("儲存檔案成功", "成功", MessageBoxButtons.OK, MessageBoxIcon.None);
            }
            catch (IOException ie)
            {
                MessageBox.Show("儲存檔案錯誤: " + ie.Message, "儲存檔案錯誤", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
