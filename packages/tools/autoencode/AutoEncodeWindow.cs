...
namespace MeGUI
{
	...
	public class AutoEncodeWindow : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.queueButton.Size = new System.Drawing.Size(41, 23);
            ...
            this.muxedOutputLabel.Text = "輸出名稱";
            // 
            // muxedOutput
            // 
            ...
            this.cancelButton.Size = new System.Drawing.Size(41, 23);
    ...
    public class AutoEncodeTool : ITool
    {
        ...
        public void Run(MainForm info)
        {
            ...
            {
                MessageBox.Show(error, "不支持的視訊設定", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
            if ((error = info.Audio.verifyAudioSettings()) != null && !error.Equals("尚未輸入音訊檔案"))            {
                MessageBox.Show(error, "不支持的音訊設定", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
