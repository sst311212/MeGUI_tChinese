...
namespace MeGUI
{
    public enum ResizeFilterType
    {
        ...
        [EnumTitle("Bilinear (柔和)", "BilinearResize({0},{1})")]
        Bilinear=0,
        [EnumTitle("Bicubic (銳利)", "BicubicResize({0},{1},0,0.75)")]
        BicubicSharp,
        [EnumTitle("Bicubic (自然)", "BicubicResize({0},{1},0,0.5)")]
        BicubicNeutral,
        [EnumTitle("Bicubic (柔和)", "BicubicResize({0},{1},0.333,0.333)")]
        BicubicSoft,
        [EnumTitle("Lanczos (銳利)", "LanczosResize({0},{1})")]
        Lanczos,
        [EnumTitle("Lanczos4 (銳利)", "Lanczos4Resize({0},{1})")]
        Lanczos4,
        [EnumTitle("Gauss (自然)", "GaussResize({0},{1})")]
        Gauss,
        [EnumTitle("Point (銳利)", "PointResize({0},{1})")]
        Point,
        [EnumTitle("Spline16 (自然)", "Spline16Resize({0},{1})")]
        Spline16,
        [EnumTitle("Spline36 (自然)", "Spline36Resize({0},{1})")]
        Spline32,
        [EnumTitle("Spline64 (銳利)", "Spline64Resize({0},{1})")]
        Spline64
    ...
    public enum DenoiseFilterType
    {
        ...
        [EnumTitle("最少噪點", "Undot()")]
        MinimalNoise = 0,
        [EnumTitle("少量噪點", "mergechroma(blur(1.3))")]
        LittleNoise,
        [EnumTitle("中量噪點", "FluxSmoothST(7,7)")]
        MediumNoise,
        [EnumTitle("大量噪點", "Convolution3D(\"movielq\")")]
        HeavyNoise
    }

    public enum NvDeinterlacerType
    {
        [EnumTitle("無去交錯", ", deinterlace=0")]
        nvDeInterlacerNone = 0,
        [EnumTitle("一倍速率去交錯", ", deinterlace=1")]
        nvDeInterlacerSingle,
        [EnumTitle("兩倍速率去交錯", ", deinterlace=2")]
        nvDeInterlacerDouble
    }

    public enum UserSourceType
    {
        [EnumTitle("逐行掃描", SourceType.PROGRESSIVE)]
        Progressive,
        [EnumTitle("格行掃描", SourceType.INTERLACED)]
        Interlaced,
        [EnumTitle("影片", SourceType.FILM)]
        Film,
        [EnumTitle("需要 M-in-5 抽取", SourceType.DECIMATING)]
        Decimating,
        [EnumTitle("混合影片/格行掃描. 多數為影片", SourceType.HYBRID_FILM_INTERLACED)]
        HybridFilmInterlaced,
        [EnumTitle("混合影片/格行掃描. 多數為格行掃描", SourceType.HYBRID_FILM_INTERLACED)]
        HybridInterlacedFilm,
        [EnumTitle("部分格行掃描", SourceType.HYBRID_PROGRESSIVE_INTERLACED)]
        HybridProgressiveInterlaced,
        [EnumTitle("部分影片", SourceType.HYBRID_PROGRESSIVE_FILM)]
        HybridProgressiveFilm
    }

    public enum UserFieldOrder
    {
        [EnumTitle("頂場優先", FieldOrder.TFF)]
        TFF,
        [EnumTitle("底場優先", FieldOrder.BFF)]
        BFF,
        [EnumTitle("不同的場順序", FieldOrder.VARIABLE)]
        Varying
    }
