    ...
    public partial class OneClickWindow : Form
    {
        ...
        public OneClickWindow(MainForm mainForm)
        {
            ...
            if (MainForm.Instance.Settings.IsDGIIndexerAvailable())
                input.Filter = "所有支援的檔案|*.avs;*.ifo;*.mkv;*.avi;*.mp4;*.flv;*.wmv;*.ogm;*.264;*.h264;*.avc;*.m2t*;*.m2ts;*.mts;*.tp;*.ts;*.trp;*.vob;*.ifo;*.mpg;*.mpeg;*.m1v;*.m2v;*.mpv;*.pva;*.vro;*.vc1;*.mpls|所有 DGAVCIndex 支援的檔案|*.264;*.h264;*.avc;*.m2t*;*.m2ts;*.mts;*.tp;*.ts;*.trp|所有 DGIndex 支援的檔案|*.vob;*.mpg;*.mpeg;*.m1v;*.m2v;*.mpv;*.tp;*.ts;*.trp;*.m2t;*.m2ts;*.pva;*.vro|所有 DGIndexNV 支援的檔案|*.264;*.h264;*.avc;*.m2v;*.mpv;*.vc1;*.mkv;*.vob;*.mpg;*.mpeg;*.m2t;*.m2ts;*.mts;*.tp;*.ts;*.trp|所有 FFMS Indexer 支援的檔案|*.mkv;*.avi;*.mp4;*.flv;*.wmv;*.ogm;*.vob;*.mpg;*.m2ts;*.ts|所有 LSMASH Indexer 支援的檔案|*.mkv;*.avi;*.mp4;*.flv;*.wmv;*.ogm;*.vob;*.mpg;*.m2ts;*.ts|AviSynth 腳本|*.avs|IFO DVD 檔案|*.ifo|Blu-Ray 撥放清單|*.mpls|所有檔案|*.*";
            else
                input.Filter = "所有支援的檔案|*.avs;*.ifo;*.mkv;*.avi;*.mp4;*.flv;*.wmv;*.ogm;*.264;*.h264;*.avc;*.m2t*;*.m2ts;*.mts;*.tp;*.ts;*.trp;*.vob;*.ifo;*.mpg;*.mpeg;*.m1v;*.m2v;*.mpv;*.pva;*.vro;*.vc1;*.mpls|所有 DGAVCIndex 支援的檔案|*.264;*.h264;*.avc;*.m2t*;*.m2ts;*.mts;*.tp;*.ts;*.trp|所有 DGIndex 支援的檔案|*.vob;*.mpg;*.mpeg;*.m1v;*.m2v;*.mpv;*.tp;*.ts;*.trp;*.m2t;*.m2ts;*.pva;*.vro|所有 DGIndexNV 支援的檔案|*.264;*.h264;*.avc;*.m2v;*.mpv;*.vc1;*.mkv;*.vob;*.mpg;*.mpeg;*.m2t;*.m2ts;*.mts;*.tp;*.ts;*.trp|所有 FFMS Indexer 支援的檔案|*.mkv;*.avi;*.mp4;*.flv;*.wmv;*.ogm;*.vob;*.mpg;*.m2ts;*.ts|所有 LSMASH Indexer 支援的檔案|*.mkv;*.avi;*.mp4;*.flv;*.wmv;*.ogm;*.vob;*.mpg;*.m2ts;*.ts|AviSynth 腳本|*.avs|IFO DVD 檔案|*.ifo|Blu-Ray 撥放清單|*.mpls|所有檔案|*.*";
        ...
        private void SubtitleRemoveTrack(int iTabPageIndex)
        {
            ...
            for (int i = 0; i < subtitlesTab.TabCount - 1; i++)
                subtitlesTab.TabPages[i].Text = "字幕 " + (i + 1);
        ...
        private void AudioRemoveTrack(int iTabPageIndex)
        {
            ...
            for (int i = 0; i < audioTab.TabCount - 1; i++)
                audioTab.TabPages[i].Text = "音訊 " + (i + 1);
